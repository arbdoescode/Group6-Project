...
{
    public class GetDorezimeArkaResult:BaseRes
    {
        ...
        public string Vlera_Kunder_Pagese_Arketim { get; set; }
        public Nullable<decimal> Totali { get; set; }
        public string Ka_Sherbime_Kunder_Pagese { get; set; }
        public string Menyre_Pagese_Kunder_Pagese { get; set; }
        public string Banka { get; set; }
        public string Numri_Cekut { get; set; }
        public string Vlera_Kunder_Pagese { get; set; }
        public string Monedha_Kunder_Pagese { get; set; }
        public string Origjina { get; set; }
        public string Agjensia_Destinacion { get; set; }
        public string Agjenia_Origjine_Kodi { get; set; }
        public string Agjensia_Destinacion_Kodi { get; set; }
        ...
        public string Kliente_Subjekte_Dergues_Kodi { get; set; }
        public string Kliente_Subjekte_Marres { get; set; }
        public string Kliente_Subjekte_Marres_Kodi { get; set; }
